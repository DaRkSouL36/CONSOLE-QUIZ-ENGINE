...
public:
    // PURPOSE: DEFAULT CONSTRUCTOR REQUIRED BY STD::VECTOR FOR RESIZING
    // INPUT: NONE
    // OUTPUT: NONE
    // LOGIC: CREATES AN EMPTY QUESTION OBJECT TO SATISFY COMPILER TEMPLATE REQUIREMENTS
    Question();
    ...
    // PURPOSE: ACTIVATES THE 50/50 LIFELINE BY MASKING TWO INCORRECT OPTIONS
    // INPUT: NONE
    // OUTPUT: NONE (MUTATES INTERNAL STATE)
    // LOGIC: CALCULATES CORRECT INDEX, GATHERS WRONG INDICES, SHUFFLES THEM, AND OVERWRITES TWO WITH '[ELIMINATED]'
    void apply5050();
};